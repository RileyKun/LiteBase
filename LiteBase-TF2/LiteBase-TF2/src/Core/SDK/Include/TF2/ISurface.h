...
public:
	...
	inline void StartDrawing()
	{
		...
		static fn FN = reinterpret_cast<fn>(g_Pattern.Find(L"vguimatsurface.dll", L"55 8B EC 64 A1 ? ? ? ? 6A FF 68 ? ? ? ? 50 64 89 25 ? ? ? ? 83 EC 14"));
		FN(this);
	...
	{
		using fn = void(__thiscall *)(void *);
		static fn FN = reinterpret_cast<fn>(g_Pattern.Find(L"vguimatsurface.dll", L"55 8B EC 6A FF 68 ? ? ? ? 64 A1 ? ? ? ? 50 64 89 25 ? ? ? ? 51 56 6A 00"));
		FN(this);
	}
};

namespace I { inline ISurface *Surface; }